...
HexColor redRectangleFigure() { return 0xFFFF0000; }

HexColor greenRectangleFigure() { return 0xFF00FF00; }

HexColor blueRectangleFigure() { return 0xFF0000FF; }
...
HexColor RetOSBackground(int x, int y, double xScaleFactor,
  ...
  if (!((int)(x * xScaleFactor * y * yScaleFactor)))
    return 0;
  return 0xFF000000 | ((((int)(0xFFFFFF * x * y * xScaleFactor * yScaleFactor) &
                         0x00FFFFFF)) ^
                       0x00FFFFFF);
}