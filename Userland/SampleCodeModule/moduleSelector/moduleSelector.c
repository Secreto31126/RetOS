...
void startModules()
{
    setpriority(PRIO_PROC, getpid(), 19); // Shell is usually very I/O bound, this prevents modules that are not I/O bound from producing more input than the shell can print.
