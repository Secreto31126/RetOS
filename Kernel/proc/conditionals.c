...
bool custom_condition(pid_t pid) { return get_process(pid)->condition_data[0]; }

bool no_condition(pid_t pid) { return true; }

bool whim_condition(pid_t pid) { return false; }
