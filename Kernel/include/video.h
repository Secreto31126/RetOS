...
/**
 * @brief Shorthand for
 * putPixelStd(GET_OPACITY(hexColor), GET_RED(hexColor), GET_GREEN(hexColor),
 * GET_BLUE(hexColor), x, y);
 *
...
/**
 * @brief The name says it all. For performance gains, it ignores the alpha
 * channel
 *
...
/**
 * @brief Receives an array, its dimensions, and the position to draw the
 * top-left corner from
 *
